...
?>
<div id="mep_0" class="mejs-container wp-audio-shortcode mejs-audio" tabindex="0" role="application" aria-label="Audio Player" style="width: 300px; height: 40px; min-width: 241px;">
   <div class="mejs-inner">
      <div class="mejs-mediaelement">
         <mediaelementwrapper id="audio-1353-1">
            <audio class="wp-audio-shortcode" id="audio-1353-1_html5" preload="none" style="width: 100%; height: 100%;" src="http://wpp.cm/wp-content/uploads/2021/06/Beyonce-Single-Ladies-Put-a-Ring-on-It.mp3?_=1">
               <source type="audio/mpeg" src="http://wpp.cm/wp-content/uploads/2021/06/Beyonce-Single-Ladies-Put-a-Ring-on-It.mp3?_=1">
               <a href="http://wpp.cm/wp-content/uploads/2021/06/Beyonce-Single-Ladies-Put-a-Ring-on-It.mp3">http://wpp.cm/wp-content/uploads/2021/06/Beyonce-Single-Ladies-Put-a-Ring-on-It.mp3</a>
            </audio>
         </mediaelementwrapper>
      </div>
      ...
      <div class="mejs-controls">
         ...
         <div class="mejs-time mejs-duration-container"><span class="mejs-duration">03:18</span></div>
         ...
         <a class="mejs-horizontal-volume-slider" href="javascript:void(0);" aria-label="Volume Slider" aria-valuemin="0" aria-valuemax="100" aria-valuenow="80" role="slider" aria-valuetext="80%">
