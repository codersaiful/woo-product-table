...
if( !function_exists( 'wpt_admin_form_top' ) ){
    ...
    function wpt_admin_form_top(){
        ...
        if( $validation ){
        ?>
        <h3 class="wpt_admin_form_links" style="margin: 0">
            <a class="wpt_get_pro_form_top_link" target="_blank" title="Awesome Pro features is Waiting for you!" href="https://codecanyon.net/item/woo-product-table-pro/20676867">Get Pro</a>  
            <a target="_blank" href="https://www.wcproducttable.xyz/demo-list/">Demo</a>
            <a target="_blank" href="https://www.wcproducttable.xyz/docs/">Basic Helps</a>
